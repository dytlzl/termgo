...
func (DograMagraView) HandleEvent(event interface{}, state *tui.GlobalState) {
...
func (DograMagraView) Title() string {
	return "Dogra Magra"
}

func (DograMagraView) Body(bool, *tui.GlobalState) []tui.Text {
